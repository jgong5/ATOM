...
3. **TODO register** — 76 items, **T1–T72 and T78–T81**, per topic. The register is not
   contiguous on this branch: T-numbers are allocated across parallel task branches, and
   T73–T76 arrive with P0.3, T77 with P0.1. T80 arrived with P0.2. T78, T79 and T81 are
   opened here. 73 are open; T15, T22 and T48 are struck through as done
