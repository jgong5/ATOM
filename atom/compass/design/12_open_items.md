...
3. **TODO register** — 76 items, **T1–T72, T78–T80 and T82**, per topic. The register is not
   contiguous on this branch: T-numbers are allocated across parallel task branches, and
   T73–T76 arrive with P0.3, T77 with P0.1, T81 with P0.4. T80 arrived with P0.2. T78, T79
   and T82 are opened here. 73 are open; T15, T22 and T48 are struck through as done
